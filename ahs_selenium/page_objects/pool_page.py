...
class PoolPage(BasePage):
    ...
    def should_be_correct_fields_internal(self):
        internal_fields_locators = \
            ["NAME", "TYPE_i", "ROLE_i", "SKILLS_i", "CITY_COUNTRY_i", "OFFICE_i", "ENG_LEVEL_i",
    ...
    """External (Blacklist) tab [FIELDS]"""
    def should_be_correct_fields_external_blacklist(self):
        external_fields_locators = \
            ["NAME", "ROLE_e", "SKILLS_e", "CITY_COUNTRY_e", "OFFICE_e", "ENG_LEVEL_e", "VISA_e", "HR_e"]
    ...
    """External (Blacklist) tab [FILTERS]"""
    ...
    def filter_label(self, label, tab):
        ...
        if label == "Bench" and tab == "Internal":
            locator_label_select = PoolPageLocators.F_LABEL_bench
        elif label == "Pre-offer" and tab == "External":
            locator_label_select = PoolPageLocators.F_LABEL_pre_offer
        elif label == "Dismiss" and (tab == "External" or tab == "Blacklist"):
            locator_label_select = PoolPageLocators.F_LABEL_dismiss
        else:
    ...
    def reset_filter_label(self):
        ...
        self.is_filter_reset(label_filter_locator)
    ...
    def reset_filter_type_internal(self):
        ...
        self.is_filter_reset(type_filter_locator)
    ...
    def filter_role(self, role, tab):
        ...
        role_select = PoolPageLocators.F_ROLE_SELECT
        # Open filter by role
    ...
    def reset_filter_cities(self, tab):
        if tab == "Internal":
            ...
            raise AssertionError("Incorrect tab-name, please specify as: 'Internal', 'External' or 'Blacklist'")
        self.is_filter_reset(city_filter_locator)
    ...
    def is_filter_reset(self, filter_locator):
        # open filter
        self.click_to_filter_by(filter_locator)
        # resetting
        reset_locator = PoolPageLocators.F_RESET
